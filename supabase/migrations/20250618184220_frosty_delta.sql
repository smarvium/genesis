/*
  # GenesisOS Initial Database Schema

  1. New Tables
    - `users` - User accounts and profiles
    - `guilds` - Digital departments/teams  
    - `agents` - Digital workers within guilds
    - `workflows` - Automation flows
    - `blueprints` - AI-generated guild blueprints
    - `simulations` - Testing results
